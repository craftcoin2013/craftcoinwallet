...
import { createSendCRC } from "../../../../../craftcoin-ord-utils/lib";
...
import { networks, payments, Psbt } from "craftcoinjs-lib";
import { KeyringServiceError } from "./consts";
import type { Hex, Json, SendCRC, UserToSignInput } from "./types";
...
class KeyringService {
  ...
  async sendCRC(data: SendCRC) {
    ...
    const psbt = await createSendCRC({
