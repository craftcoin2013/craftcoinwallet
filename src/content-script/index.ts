...
function injectScript() {
  try {
    ...
    scriptTag.setAttribute("channel", "CRAFTCOINWALLET");
    ...
    const bcm = new BroadcastChannelMessage("CRAFTCOINWALLET").listen(
    ...
    console.error("CraftCoin: Provider injection failed.", error);
  }
}
