...
const channelName = script?.getAttribute("channel") || "CRAFTCOINWALLET";
...
const provider = new NintondoProvider({
  onInit: () => {
    Object.defineProperty(window, "craftcoin", {
      value: new Proxy(provider, {
        deleteProperty: () => true,
      }),
      writable: false,
    });
    window.dispatchEvent(new Event("craftcoin#initialized"));
  },
});
